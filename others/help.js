...
module.exports = {
  ...
  execute(message,args,client) {
    ...
    .addField("• Developer", `\`\`\`yml\nName: Yogender#9138 [539499759745105921]\nName Ξ YOGENDER [539499759745105921]\`\`\``)
    .addField("• Important Links", `**[Invite Link](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot)\`|\`[Support Server](https://discord.gg/aedr5e7JyS)\`|\`[Youtube](https://youtube.com/channel/UCYULbr7ZRPlzaZSf2NdDjWQ/)\`**`)
